...
from few_tensorf.renderer import *
from few_tensorf.dataLoader import dataset_dict
...
def inference():
    ...
    if model_option and dataset_type:
        ...
        if render_button:
            with st.spinner('Wait for it...'):
                psnr, inference_folder = rendering(args, split=dataset_type, index= image_list[train_image_choice]["index"])
